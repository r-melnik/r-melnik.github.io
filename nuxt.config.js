...
const getLinks = async () => {
  ...
  [...books, ...proceedings, ...journals].forEach((publication) => {
...
export default {
  ...
  head: {
    ...
    link: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css?family=Architects+Daughter|PT+Serif&display=swap",
      },

      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css?family=Noto+Serif:400i&display=swap",
      },
      {
        rel: "stylesheet",
